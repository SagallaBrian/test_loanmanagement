        ...
        <ul>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-11">
                <div className="d-lg-flex">
                  ...
                  <div className="py-2 py-lg-0 flex-grow-1">
                    <RangePicker
          ...
          <li>
            <div className="row gx-1 py-0 py-lg-2">
              <div className=" pt-3 pt-lg-0 col-lg-1">
                {dict_filterbox[language].dormant_status.name}
              </div>
              <div className="col-lg-7">
                <div>
                  <FilterBaxCheckBox
                    optionsProp={Object.entries(
                      dict_filterbox[language].dormant_status.options
                    )}
                    paddleft
                  />
                </div>
              ...
              <div className=" pt-3 pt-lg-0 col-lg-1">
                <div className="text-nowrap overflow-hidden">
                  {dict_filterbox[language].blacklist_status.name}
                </div>
              </div>
              <div className="col-lg-3">
                <FilterBaxCheckBox
                  optionsProp={Object.entries(
                    dict_filterbox[language].blacklist_status.options
                  )}
                />
              </div>
            </div>
          ...
          <li>
            <div className="row gx-1 py-0 py-lg-2">
              <div className=" pt-3 pt-lg-0 col-lg-1">
                {dict_filterbox[language].investortype.name}
              </div>
              <div className="col-lg-7">
                <div>
                  <FilterBaxCheckBox
                    optionsProp={Object.entries(
                      dict_filterbox[language].investortype.options
                    )}
                    paddleft
                  />
                </div>
              ...
              <div className=" pt-3 pt-lg-0 col-lg-1">
                {dict_filterbox[language].invest_status.name}
              </div>
              <div className="col-lg-3">
                <FilterBaxCheckBox
                  optionsProp={Object.entries(
                    dict_filterbox[language].invest_status.options
                  )}
                />
              </div>
            </div>
          ...
          <li>
            <div className="row gx-1 py-0 py-lg-2">
              <div className=" pt-3 pt-lg-0 col-lg-1">
                {dict_filterbox[language].borrow_type.name}
              </div>
              <div className="col-lg-7">
                <div>
                  <FilterBaxCheckBox
                    optionsProp={Object.entries(
                      dict_filterbox[language].borrow_type.options
                    )}
                    paddleft
                  />
                </div>
          ...
          <li>
            <div className="row gx-1 py-0 py-lg-2">
              <div className=" pt-3 pt-lg-0 col-lg-1">
                <div className="text-nowrap overflow-hidden">
                  {dict_filterbox[language].loaninveststatus.name}
                </div>
              </div>
              <div className="col-lg-11">
                <FilterBaxCheckBox
                  optionsProp={Object.entries(
                    dict_filterbox[language].loaninveststatus.options
                  )}
                />
              </div>
            </div>
